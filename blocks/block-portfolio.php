...
class aThemes_Portfolio extends Widget_Base {
	...
	public function get_title() {
		return __( 'aThemes: Portfolio', 'atu' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'style1' => __( 'Style 1', 'atu' ),
					'style2' => __( 'Style 2', 'atu' ),
				],
				'default' => 'style2',
			]
		);		
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'name' 			=> __( 'John Doe', 'atu' ),
						'position' 		=> __( 'Manager', 'atu' ),
						'testimonial' 	=> __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla id purus neque. Curabitur pulvinar elementum neque in dictum. Sed non lectus nec tortor iaculis tincidunt.', 'atu' ),				
					],
					[
						'name' 			=> __( 'James Stevens', 'atu' ),
						'position' 		=> __( 'Manager', 'atu' ),
						'testimonial' 	=> __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla id purus neque. Curabitur pulvinar elementum neque in dictum. Sed non lectus nec tortor iaculis tincidunt.', 'atu' ),
					],
				],
				'fields' => [
					...
					[
						...
						'label_block' => true,
						'placeholder' => __( 'Title', 'atu' ),
						'default' => __( 'Project title', 'atu' ),
					],
					[
						'name' => 'term',
						'label' => __( 'Filter term', 'atu' ),
						'type' => Controls_Manager::TEXT,
						'label_block' => true,
						'placeholder' => __( 'Term for the filter', 'atu' ),
						'default' => __( 'Art', 'atu' ),
					],
					[
						'name' => 'link',
						...
						'label_block' => true,
						'placeholder' => __( 'Link for this project', 'atu' ),
						'default' => '',
					],
	...
	protected function render() {
		...
		<div class="athemes-project-wrap portfolio-section <?php echo esc_attr( $settings['style'] ); ?>">

			<ul class="project-filter clearfix" id="filters">
				<li><a href="#" class="active" data-filter="*"><?php echo esc_html__( 'Show all', 'atu' ); ?></a></li>
			...
			<div class="roll-project fullwidth loading">
				...
				<div class="loading-notice"><?php echo esc_html__( 'Loading...', 'atu' ); ?></div>
