 ...
 * @since 1.0.0
 */
class aThemes_Image_Icon_Box extends Widget_Base {
	...
	public function get_title() {
		return __( 'aThemes: Image and icon Box', 'atu' );
	}
	...
	protected function render() {
		...
		if ( ! empty( $settings['image']['url'] ) ) {
			...
			$html .= '<figure class="elementor-image-box-img">' . $image_html . '<span class="icon-wrapper"><i class="' . $settings['icon'] . '"></i></span></figure>';
	...
	protected function _content_template() {
		...
		if ( settings.image.url ) {
			...
			html += '<figure class="elementor-image-box-img">' + imageHtml + '<span class="icon-wrapper"><i class="' + settings.icon + '"></i></span></figure>';
...
Plugin::instance()->widgets_manager->register_widget_type( new aThemes_Image_Icon_Box() );